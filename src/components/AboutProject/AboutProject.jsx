      ...
      <div className={styles.about__frame}>
        <div className={styles.about__container}>
          ...
          <ul className={styles.about__items}>
            <li className={styles.aboutInfo__item}>
              <h3 className={styles.about__titleItemFirst}>Безопасность и</h3>
              <h3 className={styles.about__titleItemFirst}>конфеденциальность</h3>
            ...
            <li className={styles.aboutInfo__item}>
              <h3 className={styles.about__titleItemThird}>Удобство и</h3>
              <h3 className={styles.about__titleItemThird}>доступность</h3>
